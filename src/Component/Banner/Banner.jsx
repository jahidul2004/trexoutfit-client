    ...
    return (
        <section className="relative w-full h-[400px] flex justify-center items-center bg-black overflow-hidden mt:16 lg:mt-20">
            ...
            <figure
                ...
                style={{
                    backgroundImage:
                        "url('https://i.ibb.co.com/kgG7BXBX/Five.png')",
                }}
            ></figure>
            ...
            <section className="relative z-10 grid grid-cols-4 gap-2 max-w-4xl">
                <img
                    src="https://i.ibb.co.com/sdnMB8J4/Two.png"
                    alt="Fashion 1"
                    className="w-full h-auto object-cover"
                />
                <img
                    src="https://i.ibb.co.com/Kc8BWWh9/Onee.png"
                    className="w-full h-auto object-cover"
                />
                <img
                    src="https://i.ibb.co.com/kgG7BXBX/Five.png"
                    alt="Fashion 3"
                    className="w-full h-auto object-cover"
                />
                <img
                    src="https://i.ibb.co.com/xthv2qRT/Six.png"
                    alt="Fashion 4"
                    className="w-full h-auto object-cover"
                />
            </section>
            ...
            <header className="absolute text-white text-6xl md:text-8xl font-bold uppercase mix-blend-overlay flex items-center">
                <span className="relative z-20">FASHION</span>
                <span className="absolute inset-0 text-transparent text-stroke text-stroke-2 text-white font-extrabold z-10">
                    X
                </span>
            </header>
            ...
            <footer className="absolute bottom-4 text-white text-sm md:text-lg">
                <a
                    href="https://www.trexoutfit.shop"
